...
namespace SkyView.Classes.Menues.Menues
{
    public class EndGameWinMenu : Menu
    {
        ...
        public override void LoadConetent( GraphicsDevice graphics, ContentManager content )
        {
            ...
            Texture2D backgroundImage = _ContentManager.Load<Texture2D>( "Backgrounds\\stage" );

            _Window = new MenuWindow( menuFont, "Stage Completed", backgroundImage );
